...
mod <- cmdstan_model(here("code/models/pop_reconstruct_lognormal_init_lognormal_obs.stan"))
...
write_rds(to_save, here("output/intermediate/shona_lognormal_init_lognormal_obs.rds"))
