...
model_stuff <- read_rds(here("output/intermediate/pemba_disaggregated_model.rds"))
...
ggsave(here("output/pemba/pemba_survival.pdf"))
```
...
ggsave(here("output/pemba/pemba_fertility.pdf"))
```
...
ggsave(here("output/pemba/pemba_migration.pdf"))
```
...
ggsave(here("output/pemba/pemba_migration_detailed.pdf"))
```
...
ggsave(here("output/pemba/pemba_pop_totals.pdf"))
```
